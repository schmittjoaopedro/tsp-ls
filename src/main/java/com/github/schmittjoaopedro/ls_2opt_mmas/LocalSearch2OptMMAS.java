...
public class LocalSearch2OptMMAS {

    private static boolean dlb_flag = true;
    ...
    public static void two_opt_first(int[] tour, int nn_list[][], int[][] distance, int n, int nn_ls) {
