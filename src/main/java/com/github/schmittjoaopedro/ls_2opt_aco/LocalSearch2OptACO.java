package com.github.schmittjoaopedro.ls_2opt_aco;

public class LocalSearch2OptACO {
    ...
    public static void twoOpt(int tour[], int n, int[][] distance, int nn_list[][], int nn_ls) {
